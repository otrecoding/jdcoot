...
pure_source, pure_target, test_source, test_target = jdcoot.continuous_partial_coot(
   source, target, source_test, target_test, l_source_train, l_source_test, l_target_train, l_target_test, algo = "emd")
...
pure_source, pure_target, test_source, test_target = jdcoot.continuous_partial_jdcoot(
...
pure_source, pure_target, test_source, test_target = jdcoot.continuous_semisupervised_jdcoot(
    source, target, source_test, target_test, l_source_train, l_source_test, l_target_train, l_target_test)
...
pure_source, pure_target, test_source, test_target = jdcoot.continuous_semisupervised_reference(
    source, target, source_test, target_test, l_source_train, l_source_test, l_target_train, l_target_test)
...
pure_source, pure_target, test_pure, test_target = jdcoot.continuous_unsupervised_coot(
    source, target, source_test, target_test, l_source_train, l_source_test, l_target_train, l_target_test)
...
pure_source, pure_target, test_source, test_target = jdcoot.continuous_unsupervised_jdcoot(
    source, target, source_test, target_test, l_source_train, l_source_test, l_target_train, l_target_test)
