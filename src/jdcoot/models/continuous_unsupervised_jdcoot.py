...
def continuous_unsupervised_jdcoot( source, target, test_source, test_target, **kwargs):
    ...
    Ts, Tv, cost = cot_numpy(X1=x_source, X2=x_target, niter=100, C_lin=None, 
    ...
    perf_source = continuous_accuracy(y_source, test_source.Y)
    perf_target = continuous_accuracy(y_target, test_target.Y)
