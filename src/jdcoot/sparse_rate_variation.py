...
def Sparse_Rate_Variation(SR, Data=None, Monte_Carlo=1, algo='both', type_supervision='unsupervised',
                          ...
                          rho_target_generation=0.7, rho_target_non_generation=0.2, R2_Source=0.6, R2_Target=0.6,
    ...
    if True:
        ...
        if Store_in:
            Store((
                  ...
                  test_MC_ref_perf, test_bp_coot, test_bp_jdcoot), "Sparse_Rate_Variation")
