...
def OR_Variation(OR, Data=None, Monte_Carlo=1, Multi_Variations=True, algo='both', type_supervision='unsupervised',
    ...
    for samp_s in Sample_sizes:
        for samp_t in Sample_sizes:
            scenario_test = data_generator(math.ceil(n_Source * 0.3), math.ceil(n_Target * 0.3), d_Source, d_Target,
                                           ...
                                           Odds_Ratio_Source=samp_s, Odds_Ratio_Target=samp_t, R2_Source=R2_Source,
                                           R2_Target=R2_Source,
    ...
    if Multi_Variations:
                ...
                for samp_s in Sample_sizes:
                    for samp_t in Sample_sizes:
                        scenario = data_generator(n_Source, n_Target, d_Source, d_Target, mean_X_Source, mean_X_Target,
                                                  ...
                                                  mean_Y_Target, rho_source_generation, rho_source_non_generation,
                                                  rho_target_generation, rho_target_non_generation, Sparse_Rate,
                                                  Odds_Ratio_Source=samp_s, Odds_Ratio_Target=samp_t,
        ...
        if Store_in:
            Store((
                  ...
                  test_MC_ref_perf, test_bp_coot, test_bp_jdcoot), "OR_Variation")
        return (MC_coot_perf,
                MC_jdcoot_perf,
                MC_ref_perf,
                bp_coot,
