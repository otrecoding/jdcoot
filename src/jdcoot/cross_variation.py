...
def Cross_Partial_Labelled_Proportion_Variations(Data, Data_test=None,
                                                 Proportion_Labelled_Variations=np.array([0.1, 0.5, 0.9]),
    ...
    if Multi_Variations:
            ...
            for i in range(Monte_Carlo):
                ...
                for samp_s in Proportion_Labelled_Variations:
                    for samp_t in Proportion_Labelled_Variations:
                        ...
                        perfs = Performance(Data, Data_test, alpha=alpha, algo=algo, type_supervision='cross-partial',
        ...
        if Store_in:
            Store((
                ...
                test_MC_ref_perf, test_bp_coot, test_bp_jdcoot), "Cross_Partial_Labelled_Proportion_Variations")
