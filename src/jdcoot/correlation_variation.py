...
def Correlation_Variation(Correlation, Data=None, Monte_Carlo=1, Multi_Variations=True, algo='both',
                          ...
                          R2_Source=0.6, R2_Target=0.6, Odds_Ratio_Source=0.5, Odds_Ratio_Target=0.5,
    ...
    for samp_s in Sample_sizes:
        for samp_t in Sample_sizes:
            scenario_test = data_generator(math.ceil(n_Source * 0.3), math.ceil(n_Target * 0.3), d_Source, d_Target,
                                           mean_X_Source, mean_X_Target, mean_Y_Source,
                                           mean_Y_Target, Source_Generation_Correlation=samp_s,
                                           Source_Non_Generation_Correlation=rho_source_non_generation,
                                           Target_Generation_Correlation=samp_t,
                                           Target_Non_Generation_Correlation=rho_target_non_generation,
    ...
    if Multi_Variations:
        ...
        graph_multi(Data, algo, Sample_sizes, Objective_Variable, "Correlation variation impact", "$rho_T=rho_S$",
                    "correlation")
            ...
            for i in range(Monte_Carlo):
                ...
                for samp_s in Sample_sizes:
                    scenario = data_generator(n_Source, n_Target, d_Source, d_Target, mean_X_Source, mean_X_Target,
                                              ...
                                              mean_Y_Target, Source_Generation_Correlation=samp_s,
                                              Source_Non_Generation_Correlation=rho_source_non_generation,
                                              Target_Generation_Correlation=samp_s,
                                              Target_Non_Generation_Correlation=rho_target_non_generation,
                                              Sparse_Rate=Sparse_Rate,
                                              Odds_Ratio_Source=Odds_Ratio_Source, Odds_Ratio_Target=Odds_Ratio_Target,
                                              R2_Source=R2_Source, R2_Target=R2_Target,
                                              Observed_Covariates_Proportion_Source=Observed_Covariates_Proportion_Source,
                                              Observed_Covariates_Proportion_Target=Observed_Covariates_Proportion_Target,
                                              Indexes_Chosen_For_Generation=Indexes_Chosen_For_Generation,
        ...
        if Store_in:
            Store((
                  ...
                  test_MC_ref_perf, test_bp_coot, test_bp_jdcoot), "Correlation_Variation")
        return (MC_coot_perf,
                MC_jdcoot_perf,
                MC_ref_perf,
                bp_coot,
